    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ml-auto text-light">
          ...
          <a class="nav-link" href="#jobdesc">Job Description</a>
          <a class="btn btn-primary button" href="#contact" tabindex="-1" aria-disabled="true">Contact Us</a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <section id="about">
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <img src="./img/about.png" height="475" width="700" class="img-fluid" alt="About">
        </div>
        <div class="col-lg-5">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4">
          ...
          <ul class="list-gruop">
            ...
            <li class="list-group-item">ROAD CIANJUR</li>
    ...
    <div class="container text-center text-md-left mt-5 text-light">
      ...
      <div class="row">
        ...
        <div class="col-md-3 mx-auto mb-4">
          ...
          <p class="mt-2">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat blanditiis magnam provident numquam quod autem a perspiciatis laborum asperiores iste, assumenda, quisquam, ratione similique dolores harum! Minima blanditiis at fugit!</p>
        </div>
